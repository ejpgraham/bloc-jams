...
var createSongRow = function(songNumber, songName, songLength){
  var template =
   ...
   var clickHandler = function() {
     var clickedSongData = $(this).attr('data-song-number');
     if (clickedSongData !== currentlyPlayingSong) {
       $(this).html(pauseButtonTemplate);
       var previouslyPlayingSong =
       currentlyPlayingSong = clickedSongData;
     } else {
       currentlyPlayingSong = null;
       $(this).html(clickedSongData);
     }
   };
   ...
   var onHover = function(event){
     ...
     var songData = songItemNumber.attr('data-song-number');
